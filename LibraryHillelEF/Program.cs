...
namespace LibraryHillelEF
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    var reposuath = new AuthorRepository(unitOfWork);
            //    Author author = reposuath.Get(1).Result;
            //    var book = new Book { City = "Paris", Country = "France", PublisherCodeType = pubcode, PublisherCode = "231313131", Title = "Cool book", Authors = new List<Author> { author }, };
